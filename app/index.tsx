...
const Index = () => {
  ...
  return (
    <View style={tw`flex-1 bg-[#19262E]`}>
      <SafeAreaView style={tw`flex-1 justify-between`}>
        <Animated.View
          ...
          <Text fontSize={14} classN="mt-2 text-center text-[#FFFFFF]">
        ...
        <Animated.View
          ...
          <Pressable
            ...
            style={tw`items-center justify-center rounded-full bg-[#489A9F] w-full py-4`}>
          ...
          <Pressable
            ...
            <Text fontWeight="bold" fontSize={15} classN="text-[#19262E]">
              Sign In
            </Text>
          </Pressable>
        </Animated.View>
